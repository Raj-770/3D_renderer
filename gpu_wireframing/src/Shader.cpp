...
/**
 * @brief Manages the creation, compilation, linking, and usage of OpenGL shader
 * programs.
 *
 *        - This class loads GLSL shader source files, compiles vertex and
 * fragment shaders, links them into an OpenGL program, and provides convinience
 * functions for setting unforms.
 *
...
void Shader::setVec3(const std::string &name,
                     const MiniGLM::vec3 &value) const {
...
/**
 * @brief Loads the contents of a shader source file into a string. Throws on
 * failure.
 *
