 ...
 *        Manages 3D projection matrices (perspective and orthographic) for
 * rendering pipeline
 ...
 */
void ProjectionMatrix::setPerspective(float fovDegrees, float aspect,
                                      float nearPlane, float farPlane) {
  matrix_ = MiniGLM::perspective(MiniGLM::radians(fovDegrees), aspect,
                                 nearPlane, farPlane);
 ...
 */
void ProjectionMatrix::setOrthographic(float left, float right, float bottom,
 ...
 * @return MiniGLMmat4
 */
MiniGLM::mat4 ProjectionMatrix::getMatrix() const { return matrix_; }
 ...
 */
ProjectionMatrix::Type ProjectionMatrix::getType() const { return type_; }
